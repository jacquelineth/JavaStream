...
class Person {
    ...
    Person(String firstName, String lastName, int age) {
        ...
        if (firstName == null || lastName == null) {
            throw new NullPointerException("Names are null");
        }
    ...
    void init(String firstName, String lastName, int age) {
...
/*         java.util.Comparator<Person> cmpPerson = Comparator.comparing(Person::getAge)
    ...
    /*   Chapter 2 */
        ...
        personSup.init("Thierry", "Bouche", 50);
        //Function
        ...
        System.out.println("BinaryOperator Sum 1+2 =>"+sum4.apply(1, 2));
        ...
        System.out.println("Test 5<Hello  >20: "+mp3.test("Hello"));
